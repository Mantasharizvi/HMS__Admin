...
export default function PurchaseEntryPage() {
  ...
  const baseColumns = [
    ...
    { key: 'qty', header: 'Qty (Total)', render: (row) => row.qty ?? '—' },
    { key: 'previousQty', header: 'Previous Qty', render: (row) => row.previousQty ?? '—' },
    { key: 'previousExpiry', header: 'Previous Expiry', render: (row) => row.previousExpiry || '—' },
    { key: 'cost', header: 'Cost (Total)', render: (row) => row.cost ?? '—' },
